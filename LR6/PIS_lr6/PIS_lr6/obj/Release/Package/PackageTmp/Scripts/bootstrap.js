...
+function ($) {
  ...
  var clickHandler = function (e) {
    ...
    var target  = $attr('data-target') || href
...
+function ($) {
  ...
  Collapse.prototype.getParent = function () {
    return $(document).find(options.parent)
...
+function ($) {
  ...
  Tooltip.prototype.init = function (type, element, options) {
    ...
    $viewport = options.viewport && $(document).find($.isFunction(options.viewport) ? options.viewport.call(this, $element) : (options.viewport.selector || options.viewport))
  ...
  Tooltip.prototype.getOptions = function (options) {
    ...
    options = $.extend({}, getDefaults(), dataAttributes, options)
  ...
  Tooltip.prototype.show = function () {
    ...
    if (hasContent() && enabled) {
      ...
      options.container ? $tip.appendTo($(document).find(options.container)) : $tip.insertAfter($element)
  ...
  Tooltip.prototype.setContent = function () {
    ...
    if (options.html) {
      if (options.sanitize) {
        title = sanitizeHtml(title, options.whiteList, options.sanitizeFn)
      }
  ...
  Tooltip.prototype.sanitizeHtml = function (unsafeHtml) {
    return sanitizeHtml(unsafeHtml, options.whiteList, options.sanitizeFn)
  }
...
+function ($) {
  ...
  var Affix = function (element, options) {
    ...
    var target = options.target === Affix.DEFAULTS.target ? $(options.target) : $(document).find(options.target)
